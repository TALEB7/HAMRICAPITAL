...
import { adviceSchema, type Advice } from "@/lib/forms";
...
/** Demande de conseil — routée vers le département Info. */
export function AdviceForm() {
  ...
  const {
    ...
    defaultValues: { kind: "advice" },
  });

  const { status, errorKey, submit } = useFormPost<Advice>("advice");
